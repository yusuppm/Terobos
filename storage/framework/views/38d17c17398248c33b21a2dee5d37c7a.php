...
<section class="py-8 bg-gray-100">
    <div class="container mx-auto px-4">
        <nav class="flex items-center space-x-2 text-sm text-gray-600">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-blue-600 transition-colors duration-300">Home</a>
            <span>/</span>
            <a href="<?php echo e(route('shop.index')); ?>" class="hover:text-blue-600 transition-colors duration-300">Shop</a>
            <span>/</span>
                ...
                <div class="space-y-6" data-aos="fade-left">
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->fullUrl())); ?>&text=<?php echo e(urlencode($product->title)); ?>" 
                               target="_blank"
                            ...
                            <a href="whatsapp://send?text=<?php echo e(urlencode($product->title . ' ' . request()->fullUrl())); ?>" 
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between py-3 border-b border-gray-200">
                            ...
                            <span class="text-gray-600"><?php echo e($product->title); ?></span>
                        </div>
                        <div class="flex justify-between py-3 border-b border-gray-200">
            ...
            <div class="bg-gray-50 rounded-2xl p-8 mb-8">
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        <?php for($i = 5; $i >= 1; $i--): ?>
                            <div class="flex items-center space-x-2">
                                <span class="text-sm font-medium text-gray-700"><?php echo e($i); ?></span>
                                <i class="fas fa-star text-yellow-400 text-xs"></i>
                                <div class="flex-1 bg-gray-200 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($i == 5 ? '70' : ($i == 4 ? '20' : '5')); ?>%"></div>
                                </div>
                                <span class="text-sm text-gray-600"><?php echo e($i == 5 ? '17' : ($i == 4 ? '5' : '2')); ?></span>
                            </div>
                        <?php endfor; ?>
                    </div>
                </div>
                ...
                <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105" data-aos="fade-up" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                        <div class="relative overflow-hidden group">
                            <img src="<?php echo e(Storage::url($related->foto_product)); ?>" 
                        ...
                        <div class="p-6">
                            ...
                            <div class="text-gray-600 mb-4 text-sm line-clamp-2">
                                <?php echo Str::limit(strip_tags($related->description), 80); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\rosus\resources\views\shop\show.blade.php ENDPATH**/ ?>