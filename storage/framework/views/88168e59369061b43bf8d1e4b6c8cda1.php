    ...
    <div class="relative z-10 container mx-auto px-4 py-16">
        <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="space-y-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="<?php echo e(url('/')); ?>" class="flex items-center text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300">
                            <i class="fas fa-angle-right mr-3 text-blue-400"></i>
                            Home
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/about')); ?>" class="flex items-center text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300">
                            <i class="fas fa-angle-right mr-3 text-blue-400"></i>
                            About
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/services')); ?>" class="flex items-center text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300">
                            <i class="fas fa-angle-right mr-3 text-blue-400"></i>
                            Services
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/projects')); ?>" class="flex items-center text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300">
                            <i class="fas fa-angle-right mr-3 text-blue-400"></i>
                            Projects
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/contact')); ?>" class="flex items-center text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300">
                            <i class="fas fa-angle-right mr-3 text-blue-400"></i>
                            Contact Us
                        </a>
                    </li>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-gray-300 text-center md:text-left">
                    © <?php echo e(date('Y')); ?> Rosus Platform. All Rights Reserved.
                </p>
...
</footer><?php /**PATH E:\rosus\resources\views\partials\footer.blade.php ENDPATH**/ ?>