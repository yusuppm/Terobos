                ...
                <?php if($projects && $projects->count() > 0): ?>
                    ...
                    <div class="bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden card-hover group">
                        ...
                        <div class="p-6 sm:p-8">
                            <h5 class="text-xl sm:text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300"><?php echo e($project->title); ?></h5>
                            <p class="text-gray-600 mb-4 sm:mb-6 line-clamp-3 leading-relaxed text-sm sm:text-base"><?php echo Str::limit($project->description, 150); ?></p>
                            <a href="<?php echo e(route('projects.show', $project->slug)); ?>" class="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto">
                                <span>Read More</span>
...
<section id="shop" class="py-16 sm:py-24 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10" data-aos="fade-right">
                ...
                <?php if($products && $products->count() > 0): ?>
                    ...
                    <div class="bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden card-hover group">
                        ...
                        <div class="p-6 sm:p-8 text-center">
                            <h4 class="text-lg sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-blue-600 transition-colors duration-300"><?php echo e($product->title); ?></h4>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('shop.index')); ?>" class="inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 border-3 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-base sm:text-lg">
...
<section id="news" class="py-16 sm:py-24 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10" data-aos="fade-up">
        ...
        <div class="mb-12 sm:mb-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <?php if($news && $news->count() > 0): ?>
                    <?php $__currentLoopData = $news->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden card-hover group">
                        <div class="relative overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8">
                            ...
                            <a href="<?php echo e(route('news.show', $article->slug)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-bold transition-all duration-300 transform hover:scale-105 text-sm sm:text-base">
                                <span>Read More</span>
                                <i class="fas fa-arrow-right ml-2 transition-transform duration-300 group-hover:translate-x-1"></i>
                            </a>
                        </div>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('news.index')); ?>" class="inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 border-3 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-base sm:text-lg">
