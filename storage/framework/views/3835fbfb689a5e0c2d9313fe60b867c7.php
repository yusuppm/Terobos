...
<section id="projects" class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10" data-aos="fade-right">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl shadow-lg overflow-hidden card-hover group">
                            <div class="relative overflow-hidden">
                                <img src="<?php echo e($project->thumbnail ? asset('storage/' . $project->thumbnail) : asset('assets/images/banner-image.png')); ?>" 
                            ...
                            <div class="p-8">
                                <h5 class="text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300"><?php echo e($project->title); ?></h5>
                                <p class="text-gray-600 mb-6 line-clamp-3 leading-relaxed"><?php echo Str::limit($project->description, 150); ?></p>
                                <a href="<?php echo e(route('projects.show', $project->slug)); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                    <span>Read More</span>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('projects.index')); ?>" class=" bg-white inline-flex items-center justify-center px-12 py-5 border-3 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg">
...
<section id="shop" class="py-24 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10" data-aos="fade-right">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl shadow-lg overflow-hidden card-hover group">
                            <div class="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-8">
                                <img src="<?php echo e($product->foto_product ? asset('storage/' . $product->foto_product) : asset('assets/images/choose-image.png')); ?>" 
                            ...
                            <div class="p-8 text-center">
                                <h4 class="text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300"><?php echo e($product->title); ?></h4>
                                ...
                                <a href="<?php echo e(route('shop.show', $product->slug)); ?>" class="w-full inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
        ...
        <div class="text-center">
            <a href="<?php echo e(route('shop.index')); ?>" class="inline-flex items-center justify-center px-12 py-5 border-3 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg">
...
<section id="news" class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10" data-aos="fade-up">
            ...
            <div class="swiper-wrapper mb-2">
                ...
                <?php if($news && $news->count() > 0): ?>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl shadow-lg overflow-hidden card-hover group">
                            <div class="relative overflow-hidden">
                                <img src="<?php echo e($article->thumbnail ? asset('storage/' . $article->thumbnail) : asset('assets/images/news-default.jpg')); ?>" 
                                     class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-110" 
                                ...
                                <div class="absolute top-4 left-4">
                                    <span class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-bold">
                                        ...
                                        <?php echo e($article->kategory ?? 'News'); ?>
                            ...
                            <div class="p-8">
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($article->tanggal)->format('M d, Y')); ?></span>
                                    </div>
                                    <span class="mx-3 text-gray-300">•</span>
                                    <div class="flex items-center">
                                        <i class="fas fa-user mr-2 text-purple-600"></i>
                                        <span class="font-semibold"><?php echo e($article->ditulis_oleh ?? 'Admin'); ?></span>
                                    </div>
                                </div>
                                ...
                                <p class="text-gray-600 mb-6 line-clamp-3 leading-relaxed">
                                    <?php echo Str::limit($article->description, 150); ?>

                                </p>
                                <a href="<?php echo e(route('news.show', $article->slug)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-bold transition-all duration-300 transform hover:scale-105">
                                    <span>Read More</span>
                                    <i class="fas fa-arrow-right ml-2 transition-transform duration-300 group-hover:translate-x-1"></i>
                                </a>
                            </div>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('news.index')); ?>" class="inline-flex items-center justify-center px-12 py-5 border-3 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\rosus\resources\views/pages/home.blade.php ENDPATH**/ ?>