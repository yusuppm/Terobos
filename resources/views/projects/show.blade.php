...
<section class="relative py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center text-white">
            <nav class="mb-8">
                <a href="{{ route('projects.index') }}" class="text-blue-300 hover:text-white transition-colors duration-300">
            ...
            @foreach($relatedProjects as $relatedProject)
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <div class="relative overflow-hidden">
                        <img src="{{ Storage::url($relatedProject->thumbnail) }}" 
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 line-clamp-3">
                            {!! Str::limit(strip_tags($relatedProject->description), 120) !!}
                        </p>
...
<section class="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            ...
            <a href="{{ route('projects.index') }}" class="inline-flex items-center px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold rounded-full transition-all duration-300">
                View All Projects
                <i class="fas fa-arrow-right ml-2"></i>
            </a>
        </div>
