...
<section class="py-8 bg-white border-b">
    <div class="container mx-auto px-4">
        <form method="GET" action="{{ route('shop.index') }}" class="flex flex-wrap gap-4 items-center justify-between">
            <div class="flex flex-wrap gap-4">
                ...
                <select name="price_range" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="1000-5000" {{ request('price_range') == '1000-5000' ? 'selected' : '' }}>$1000 - $5000</option>
                    <option value="5000+" {{ request('price_range') == '5000+' ? 'selected' : '' }}>Above $5000</option>
                </select>
            ...
            @if(request()->hasAny(['search', 'price_range', 'sort']))
                <a href="{{ route('shop.index') }}" class="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors duration-300">
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="text-gray-500">
                    @if(request()->hasAny(['search', 'price_range', 'sort']))
                        Try adjusting your search criteria or <a href="{{ route('shop.index') }}" class="text-blue-600 hover:text-blue-800">view all products</a>.
                    @else
