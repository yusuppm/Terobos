...
<section class="py-20 bg-gray-50 relative overflow-hidden">
    <div class="container mx-auto px-4" data-aos="fade-right">
        <!-- Background Image -->
        <figure class="absolute top-0 right-0 w-1/3 h-full opacity-10 hidden lg:block">
            <img src="./assets/images/service-image.png" class="w-full h-full object-cover" alt="Service Background">
        </figure>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Service Card 1 -->
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        <figure class="w-16 h-16 mb-4 bg-gradient-to-r from-blue-100 to-blue-200 rounded-xl flex items-center justify-center">
                            <img src="./assets/images/service-reboticon.png" alt="Robotic Automation" class="w-8 h-8">
                        </figure>
                        ...
                        <a href="./service.html" class="text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-300">
                            Read More →
                        </a>
                    </div>
                    
                    <!-- Service Card 2 -->
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 md:mt-8">
                        <figure class="w-16 h-16 mb-4 bg-gradient-to-r from-purple-100 to-purple-200 rounded-xl flex items-center justify-center">
                            <img src="./assets/images/service-learningicon.png" alt="Machine Learning" class="w-8 h-8">
                        </figure>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        <figure class="w-16 h-16 mb-4 bg-gradient-to-r from-green-100 to-green-200 rounded-xl flex items-center justify-center">
                            <img src="./assets/images/service-scienceicon.png" alt="Education & Science" class="w-8 h-8">
                        </figure>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 md:mt-8">
                        <figure class="w-16 h-16 mb-4 bg-gradient-to-r from-orange-100 to-orange-200 rounded-xl flex items-center justify-center">
                            <img src="./assets/images/service-analysicon.png" alt="Predictive Analysis" class="w-8 h-8">
                        </figure>
